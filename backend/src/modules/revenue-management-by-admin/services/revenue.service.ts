...
export class RevenueService {
  ...
  public async getRevenueData(filters: {
    ...
    // console.log("🌡️ WhereClause built: ", JSON.stringify(whereClause, null, 2));
    ...
    const [
      ...
      this.revenueRepository.getRevenueByDay(
        whereClause,
        filters.period || "year"
      ),
    ...
    return {
      stats: {
        ...
        totalTransactions,
        averageTransaction:
          totalTransactions > 0 ? Number(totalRevenue) / totalTransactions : 0,
      },
