...
import type { CreateFlashcardInput } from "@/modules/flashcards/dtos/flashcard.dto";
...
export class FlashcardController {
  ...
  public createFlashcard = async (
    ...
    try {
      ...
      const {frontContent, backContent, exampleSentence, audioUrl,deckId} = req.body;
      const newFlashcard =
        await this.flashcardService.createFlashcard(
          userId,
          {frontContent, backContent, exampleSentence, audioUrl,deckId}
        );
